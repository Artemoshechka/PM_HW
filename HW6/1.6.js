...
let reg_exp = /\(\d{3}\) \d{3}-\d{2}-\d{2}/;

for (let char of array){
    Object.defineProperty(char, 'phone_change', {
        set(value){
            if (reg_exp.test(value) === false){
...
array[1].phone_change = 'bfdbesadfn ';
console.log(array[1].phone);
array[1].phone_change = '(067) 999-99-28';
console.log(array[1].phone);
